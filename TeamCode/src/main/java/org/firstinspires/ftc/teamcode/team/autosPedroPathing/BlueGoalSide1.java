...
public class BlueGoalSide1 extends DarienOpModeFSM {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        autoPlan = new AutoPlan()
                ...
                .add(new FollowPathStep(BlueGoalSidePaths.buildParking1(follower), PATH_POWER_STANDARD, LONG_PATH_TIMEOUT))
                .add(new ShootSequenceStep(ShootingFSM.PowerLevel.CLOSE, SHOOT_TRIPLE_TIMEOUT))
                .add(new StopShotgunStep())
                .add(new CleanupStep());

        panelsTelemetry.debug("Status", "Initialized");
        telemetry.addLine("BlueGoalSide1: READY");
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            addTraceTelemetry("Auto-BlueGoalSide1", autoPlan.getStatus(), planTimer.getElapsedTimeSeconds());
            displayRpmTelemetry();
            panelsTelemetry.update(telemetry);
